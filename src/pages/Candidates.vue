    ...
    <div style="display:grid;grid-template-columns:9fr 3fr;gap:20px;margin-bottom:24px;">
      ...
      <div class="section-card">
        ...
        <div style="padding:10px;">
          ...
          <div v-if="progressMsg" style="font-size:13px;padding:5px;border-radius:8px;background:#f3fff3;color:#388e3c;border:1px solid #c8e6c9;margin-bottom:6px;">{{ progressMsg }}</div>
